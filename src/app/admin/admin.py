...
@admin_router.patch("/admin-verify-and-unverify-user/{uid}")
...
# Delete users,
@admin_router.delete("/admin-delete-user/{uid}")
...
# Change user roles
@admin_router.patch("/admin-change-user-role/{uid}")
...
# View query logs 
@admin_router.get("/admin-get-query-logs")
